return {
...

    {
        "saghen/blink.cmp",
        opts = {
            -- Use <Tab> to accept the completion instead of <CR>.
            -- super-tab: <Tab> selects+accepts the (first) item, jumps
            -- snippets, or falls back to a normal tab when the menu is closed.
            -- <S-Tab> jumps snippets backward; <Up>/<Down> select items.
            keymap = {
                preset = "super-tab",
            },
        },
